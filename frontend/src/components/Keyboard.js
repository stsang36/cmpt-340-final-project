...
<div className="z-50 fixed bottom-0 left-0 w-full flex flex-col justify-end">
            ...
            <div className="w-full h-[50px] flex flex-row border-t-2 border-black bg-[#2594D9] lg:h-[65px]">
                ...
                <div className="h-full w-[21.875%] border-r-2 border-black flex flex-row items-center justify-center"><p className="text-white lg:text-lg">Word 1</p></div>
                <div className="h-full w-[21.875%] border-r-2 border-black flex flex-row items-center justify-center"><p className="text-white lg:text-lg">Word 2</p></div>

                <button className="w-[12.5%] h-full rounded-md flex flex-row justify-center items-center font-bold text-black"><img className="object-cover w-[30px] h-[30px] sm:w-[35px] sm:h-[35px] md:w-[40px] md:h-[40px] lg:w-[45px] lg:h-[45px]" src="../assets/images/png/hide-keyboard-icon.png" alt="shortcut icon"/></button>

                <div className="h-full w-[21.875%] border-l-2 border-black flex flex-row items-center justify-center"><p className="text-white lg:text-lg">Word 3</p></div>
                <div className="h-full w-[21.875%] border-l-2 border-black flex flex-row items-center justify-center"><p className="text-white lg:text-lg">Word 4</p></div>
            </div>
