...
const App = () => {
  ...
  return (
    <Router>
      ...
      <Routes>
        <Route path='/login' element={!isLoggedIn ? <Login isVisible={keyboardVisible} closeKeyboard={closeKeyboard} openKeyboard={openKeyboard} isLoggedIn={isLoggedIn} setIsLoggedIn={setIsLoggedIn} keyColor={keyColor} setKeyColor={setKeyColor} /> : <Navigate to="/" />} />
        <Route path='/register' element={!isLoggedIn ? <Register isVisible={keyboardVisible} closeKeyboard={closeKeyboard} openKeyboard={openKeyboard} keyColor={keyColor} setKeyColor={setKeyColor} /> : <Navigate to="/" />} />
        <Route path='/' element={
          <>
            <Header />
